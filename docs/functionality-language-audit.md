...
| `student` | Own dashboard, submissions/evidence, archive readiness, presentation scope, own record. | Student homepage now has a progress-first dashboard using real requirements/submissions/evidence/mentor data and latest teacher feedback from own submissions. | No full student-specific history pages for feedback, phase detail, or due-date timeline. |
