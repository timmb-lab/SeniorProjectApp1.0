...
- `tests/alpha-flow.test.mjs`, `scripts/check-alpha-contract.mjs`, `scripts/verify-cadence-30min.ps1`, `npm run check`, `npm run deploy:preview`, and `.github/workflows/ci.yml` add the alpha verification and preview rails.
