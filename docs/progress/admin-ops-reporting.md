...
- Primary requirements: `MVP-018`, `MVP-019`, `MVP-020`, `MVP-023`, `MVP-024`, `MVP-025`, plus reporting/audit portions of `MVP-001`.
- Current target: admin-facing reporting, announcement publishing without student-to-student messaging, exports, redacted audit visibility, and operational closeout evidence.
