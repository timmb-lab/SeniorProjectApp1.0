...
- `commit`: implementation commit `c2477ec9febae91893fb3b12c2ebd1e67393336e` (`rebuild: add student teacher guide toggle (MVP-035)`) and closeout evidence commit `a9e0a1d` pushed to `origin main`; phone tracker evidence commit pending.
