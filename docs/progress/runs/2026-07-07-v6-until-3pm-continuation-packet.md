...
- Current implementation SHA: `0575f5b`
- START_TIME_PHOENIX: `2026-07-07 07:20:40 America/Phoenix`
- TARGET_NOT_BEFORE_TIME_LOCAL: `2026-07-07 15:00 America/Phoenix`
- Latest stable implementation commit: slice 20 `0575f5b` (`Clarify admin people scope copy`)
- Commits since V6 start: `32` before this proof-artifact checkpoint commit
...
3. Use the V6 screenshot set and checkpoint log to pick the next target; the latest completed target was replacing Admin People `inside the current view` copy with selected-school/global-scope wording.
