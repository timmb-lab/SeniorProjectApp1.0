...
- `latest Figma handoff`: 2026-05-20 node `139:2` was consumed by the non-Figma workspace Presentation tab for persisted slot visibility and staff check-out/check-in controls; remaining presentation work is hosted proof plus outline approval, celebration, and archive/export depth.
