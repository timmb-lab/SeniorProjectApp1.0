...
- `next action`: Add Drive-backed package files or signed-link delivery, apply/verify remote migration `0007`, and capture hosted archive UI proof after `CLOUDFLARE_API_TOKEN` plus Google Drive credential secrets are available.
