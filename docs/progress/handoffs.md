...
- `next action`: Finish the scaffold by broadening permission tests, resolving the Drive upload HTTP 403, deciding whether email delivery or invitations are needed beyond one-time admin display credentials, and implementing first admin/progress workflow endpoints.
