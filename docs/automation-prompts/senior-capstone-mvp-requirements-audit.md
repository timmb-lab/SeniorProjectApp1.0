...
prompt_sha256: "1c79c9820c757217d68a36eea530d8a6b7ba620543152d06f02c5d61078ab091"
...
Schedule intent: run 4x/day in America/Los_Angeles at 00:05, 06:05, 12:05, and 18:05. Keep this category ACTIVE unless Bryan explicitly asks otherwise.
...
Weekly calibration: on Sundays, count accepted MVP passes from the last seven days of commits, docs/progress/run-log.md, docs/progress/runs/, backlog movement, handoffs, and blockers. Update only this project's docs/master-plan.md, docs/automation-memory.md, and docs/mvp-requirements-catalog.md when evidence says the next week's daily goal or category allocation should change.

Primary requirement IDs: MVP-001, MVP-002, MVP-003, MVP-009, MVP-030, plus any stale P0/P1 backlog item.
