...
| MVP-011 | Provide student dashboard with phase, next action, due items, evidence needs, revision state, and program context. | `student-workflow-evidence` | Alpha student workspace, server-derived next-step guidance, reviewer checks, copyable walkthrough summary, and Figma student desktop/mobile frames. | Mobile and desktop walkthrough shows live state changes after submit/revision/approval. | `alpha active` |
