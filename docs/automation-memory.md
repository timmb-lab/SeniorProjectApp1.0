...
6. Continue broadening route-level protected-record tests after the dashboard and teacher review queue access audits by covering review detail/history/decision, submissions, mentor meetings, presentation slots, archive/export, and live/browser permission-denied states, using Figma nodes `173:2` and `178:2` as the protected-access contracts.
