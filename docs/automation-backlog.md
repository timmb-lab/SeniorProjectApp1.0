...
This file tracks unresolved cross-category issues for the Senior Capstone rebuild. The `senior-capstone-qol-source-framework-seed-2` automation owns backlog hygiene because it owns source-framework/catalog alignment in the current QoL system.
