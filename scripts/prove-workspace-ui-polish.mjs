...
const SCREENSHOT_PLAN = [
  ...
  },
  {
    ...
    viewport: { width: 1440, height: 900, deviceScaleFactor: 1, mobile: false },
    expected: ["My Capstone", "What do I need to do next?", "Your Senior Project"],
    absent: ["Admin Console", "Staff Workspace"],
    proves: "Student lands on My Capstone with student-only navigation.",
  },
  {
    id: "07-student-phone",
    label: "Student phone",
    ...
    expected: ["My Capstone", "What do I need to do next?"],
    absent: ["Admin Console", "Staff Workspace"],
