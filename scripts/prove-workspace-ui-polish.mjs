...
const SCREENSHOT_PLAN = [
  {
    ...
    expected: ["Admin Console", "Operations Overview", "What to fix first", "Open the exact setup screen", "Current scope health", "Latest changes in this scope"],
    absent: ["Demo proof guard", "What this role can manage or monitor", "What to do first"],
    proves: "Global Admin sees the operations-first Admin Console overview with setup issues, health, quick actions, and activity.",
  },
  {
  ...
  },
  {
    ...
    expected: ["Admin Console", "Operations Overview", "What to fix first", "Open the exact setup screen"],
    absent: ["Demo proof guard", "What this role can manage or monitor", "What to do first"],
  ...
  },
  {
    ...
    viewport: { width: 1440, height: 900, deviceScaleFactor: 1, mobile: false },
    expected: ["Admin Console", "Operations Overview", "What to fix first", "Open the exact setup screen", "Current scope health"],
    absent: ["Demo proof guard", "What this role can manage or monitor", "Security checks that are enforced now"],
    proves: "Site Admin sees the rebuilt operations overview inside school scope.",
  },
  {
