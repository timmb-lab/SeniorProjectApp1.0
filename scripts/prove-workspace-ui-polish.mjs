...
const SCREENSHOT_PLAN = [
  {
    ...
    expected: ["Admin Console", "Operations Overview", "What to fix first", "Setup work to review", "Open the exact setup screen", "Current scope health", "Latest changes in this scope"],
  ...
  },
  {
    ...
    expected: ["Admin Console", "Operations Overview", "What to fix first", "Setup work to review", "Open the exact setup screen"],
    absent: ["Demo proof guard", "What this role can manage or monitor", "What to do first"],
  ...
  },
  {
    ...
    viewport: { width: 1440, height: 900, deviceScaleFactor: 1, mobile: false },
    expected: ["Admin Console", "Operations Overview", "What to fix first", "Setup work to review", "Open the exact setup screen", "Current scope health"],
  ...
  },
  {
    ...
    viewport: { width: 1440, height: 900, deviceScaleFactor: 1, mobile: false },
    expected: ["Reports", "Operational Reports", "Setup work to review", "Operational coverage summary", "Roster completeness", "Mentor coverage"],
