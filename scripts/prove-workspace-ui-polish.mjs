...
const SCREENSHOT_PLAN = [
  ...
  },
  {
    ...
    viewport: { width: 1440, height: 900, deviceScaleFactor: 1, mobile: false },
    expected: ["My Work", "Where do I open, submit, or review my capstone work?", "Current Work", "Work You Turned In", "Proof Files"],
  ...
  },
  {
    ...
    viewport: { width: 1440, height: 900, deviceScaleFactor: 1, mobile: false },
    expected: ["Feedback", "What feedback did I receive, and what do I need to fix?", "Needs Changes", "Recent Feedback", "Past Feedback"],
    absent: ["Admin Console", "Staff Workspace", "Showing 0 of 0"],
