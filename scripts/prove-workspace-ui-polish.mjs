...
const SCREENSHOT_PLAN = [
  ...
  },
  {
    ...
    viewport: { width: 1440, height: 900, deviceScaleFactor: 1, mobile: false },
    expected: ["My Capstone", "What do I need to do next?", "Review My Work", "Progress Tracker"],
  ...
  },
  {
    ...
    expected: ["My Capstone", "What do I need to do next?", "Review My Work"],
    absent: ["Admin Console", "Staff Workspace"],
  ...
  },
  {
    ...
    url: workspaceUrl("?mode=admin&section=students&siteId=site-desert-valley-high"),
    viewport: { width: 1440, height: 900, deviceScaleFactor: 1, mobile: false },
    expected: ["Students", "View as Student"],
    absent: ["Viewing as:"],
  ...
  },
  {
    ...
    viewport: { width: 1440, height: 900, deviceScaleFactor: 1, mobile: false },
    expected: ["Final Checklist", "What is left before I am finished?", "Finish checks"],
    absent: ["Admin Console", "Staff Workspace"],
  ...
  },
  {
    ...
    viewport: { width: 1440, height: 900, deviceScaleFactor: 1, mobile: false },
    expected: ["My Work", "Where do I open, submit, or review my capstone work?", "Current Work", "Submitted Work", "Evidence / Files"],
    absent: ["Admin Console", "Staff Workspace", "Showing 0 of 0"],
    proves: "Student My Work shows checklist, submitted work, and proof rows as the work surface.",
  },
  {
    ...
    expected: ["My Work", "Where do I open, submit, or review my capstone work?", "Current Work", "Submitted Work", "Evidence / Files"],
    absent: ["Admin Console", "Staff Workspace", "Showing 0 of 0"],
    proves: "Student My Work keeps current work, submitted work, and evidence rows readable on phone width.",
  },
  {
    ...
    viewport: { width: 1440, height: 900, deviceScaleFactor: 1, mobile: false },
    expected: ["Feedback", "What feedback did I receive, and what do I need to fix?", "Needs Revision", "Recent Feedback", "Past Feedback"],
    absent: ["Admin Console", "Staff Workspace", "Showing 0 of 0"],
  ...
  },
  {
    ...
    viewport: { width: 1440, height: 900, deviceScaleFactor: 1, mobile: false },
    expected: ["STUDENT DETAIL", "Evidence", "EVIDENCE RECORDS"],
  ...
  },
  {
    ...
    url: workspaceUrl("?mode=workspace&section=students&siteId=site-desert-valley-high"),
    viewport: { width: 390, height: 844, deviceScaleFactor: 2, mobile: true },
    expected: ["Student detail", "Overview", "Work", "Back to Students"],
    action: "clickFirstStudentDetail",
  ...
  },
  {
    ...
    url: workspaceUrl("?mode=workspace&section=students&siteId=site-desert-valley-high"),
    viewport: { width: 390, height: 844, deviceScaleFactor: 2, mobile: true },
    expected: ["Students", "Search the students this account can access", "Action map", "Open Student"],
    absent: ["Showing 0 of 0", "Role context", "Demo boundary"],
    proves: "Staff Students keeps filters, action-map context, and row actions readable on phone width.",
  },
  {
    ...
    url: workspaceUrl("?mode=workspace&section=students&siteId=site-desert-valley-high"),
    viewport: { width: 390, height: 844, deviceScaleFactor: 2, mobile: true },
    expected: ["STUDENT DETAIL", "Evidence", "EVIDENCE RECORDS", "Protected file details"],
  ...
  },
  {
    ...
    url: workspaceUrl("?section=students&siteId=site-desert-valley-high"),
    viewport: { width: 390, height: 844, deviceScaleFactor: 2, mobile: true },
    expected: ["Students", "Search the students this account can access", "Assigned records only", "Read-only"],
    absent: ["Admin Console", "Remove student", "Manage Site Access"],
    proves: "Viewer Students keeps assigned-record, read-only context readable on phone width.",
  },
  {
    id: "40-staff-reviews",
    label: "Staff Reviews",
  ...
  return client.evaluate(`(() => {
    ...
    return {
      ...
      markers: {
        ...
        studentDirectory: Boolean(document.querySelector("[data-student-directory-action-map='true']")),
