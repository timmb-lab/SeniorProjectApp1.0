...
const SCREENSHOT_PLAN = [
  {
    ...
    expected: ["Admin Console", "Operations Overview", "People"],
    absent: ["Demo proof guard", "What this role can manage or monitor"],
    proves: "Global Admin sees the operations-first Admin Console overview.",
  },
  {
    ...
    expected: ["Staff Workspace", "Which students need attention today?", "Need setup or access work?"],
  ...
  },
  {
    ...
    viewport: { width: 1440, height: 900, deviceScaleFactor: 1, mobile: false },
    expected: ["Staff Workspace", "Program Teacher Dashboard", "Review Queue"],
  ...
  },
  {
    ...
    url: workspaceUrl("?section=overview"),
    viewport: { width: 1440, height: 900, deviceScaleFactor: 1, mobile: false },
    expected: ["Staff Workspace", "MENTOR DASHBOARD", "Assigned Student Focus"],
  ...
  },
  {
    ...
    url: workspaceUrl("?section=overview"),
    viewport: { width: 1440, height: 900, deviceScaleFactor: 1, mobile: false },
    expected: ["Staff Workspace", "Read-only", "Student Directory"],
    absent: ["Admin Console", "Role context"],
  ...
  },
  {
    ...
    expected: ["Admin Console", "Operations Overview", "What to do first"],
    absent: ["Demo proof guard", "What this role can manage or monitor"],
  ...
  },
  {
    ...
    url: workspaceUrl("?mode=workspace&section=overview"),
    viewport: { width: 820, height: 900, deviceScaleFactor: 1, mobile: false },
    expected: ["Staff Workspace", "Which students need attention today?"],
    absent: ["Daily workspace is clear", "Role context"],
  ...
  },
  {
    ...
    viewport: { width: 1440, height: 900, deviceScaleFactor: 1, mobile: false },
    expected: ["People", "Add Staff", "Manage Staff"],
    proves: "People opens as an Admin Console operations section.",
  },
  {
