...
const customDomainRows = [
  ...
  [
    productionDomains.redirectHostnames.productWwwAlias,
    "product www redirect",
    productionDomains.pagesProjects.appBackend,
    ".deploy-app/",
    "npm run deploy",
    productionDomains.pagesDevFallbacks.appBackend,
  ...
  [
    productionDomains.redirectHostnames.secondaryApex,
  ...
  [
    productionDomains.redirectHostnames.secondaryWwwAlias,
    "secondary www redirect",
    productionDomains.pagesProjects.appBackend,
    ".deploy-app/",
    "npm run deploy",
    productionDomains.pagesDevFallbacks.appBackend,
  ...
  [
    productionDomains.redirectHostnames.pagesDevAlias,
    "direct Pages project alias redirects to canonical domain",
    productionDomains.pagesProjects.appBackend,
    ".deploy-app/",
    "npm run deploy",
    productionDomains.pagesDevFallbacks.appBackend,
...
const customDomainPolicyRows = [
  ...
  ["Canonical URL", productionDomains.canonicalUrl],
  ...
  ["Alpha/account policy", "Option C is active: local QA source remains, but the production bundle excludes alpha/account files and production routes return 404."],
];
